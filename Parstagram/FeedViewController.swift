...
class FeedViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, MessageInputBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        tableView.keyboardDismissMode = .interactive //diusmiss keyboard by dragging down on keyboard
    ...
    @objc func keyboardWillBeHidden(note: Notification){
        ...
        commentBar.inputTextView.resignFirstResponder() //maybe
    }
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        query.includeKeys(["author", "profile_image", "comments", "comments.author"])
        query.limit = 20
    ...
    func messageInputBar(_ inputBar: MessageInputBar, didPressSendButtonWith text: String) {
        ...
        tableView.reloadData() //to make comment appear immediately
